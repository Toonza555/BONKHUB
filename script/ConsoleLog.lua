...
do
    local Console = game:GetService("CoreGui"):FindFirstChild("BONK_Console")
    if Console then
        Console:Destroy()
    end
    local ConsoleButton = game:GetService("CoreGui"):FindFirstChild("BonkConsole")
...
function Console:Window(consoledebugger)
    ...
    local BONK_Console = Instance.new("ScreenGui")
    ...
    BONK_Console.Name = "BONK_Console"
    BONK_Console.Parent = game.CoreGui
    BONK_Console.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    
    ambientShadow.Name = "ambientShadow"
    ambientShadow.Parent = BONK_Console
    ambientShadow.AnchorPoint = Vector2.new(0.5, 0.5)
    ambientShadow.BackgroundTransparency = 1.000
    ambientShadow.BorderSizePixel = 0
    ambientShadow.Position = GuiPosition
    ambientShadow.Size = UDim2.new(0, 600, 0, 350) --510
    ...
    Window.Size = UDim2.new(0, 600, 0, 350) --500
    Window.ZIndex = 2
    ...
    ConsoleContainer.Size = UDim2.new(0, 580, 0, 290) --440
    ...
    ConsoleContainerUIListLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
    ...
    WindowTitle.Size = UDim2.new(0, 323, 0, 40)--40
    ...
    local function onInputBegan(input, gameProcessed)
        if input.UserInputType == Enum.UserInputType.Keyboard then
            if input.KeyCode == Enum.KeyCode.RightAlt then
                BONK_Console.Enabled = not BONK_Console.Enabled
            end
        end
    end
...
local BonkConsole = Instance.new("ScreenGui")
    ...
    local MODILEMAGE = Instance.new("ImageLabel")
        ...
        BonkConsole.Name = "BonkConsole"
        BonkConsole.Parent = game.CoreGui
        BonkConsole.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

        BonkButton.Name = "BonkButton"
        BonkButton.Parent = BonkConsole
        BonkButton.BackgroundColor3 = Color3.fromRGB(0,0,0)
        BonkButton.BorderSizePixel = 0
        BonkButton.Position = UDim2.new(0, 0, 0.0952890813, 0)
        BonkButton.Size = UDim2.new(0, 50, 0, 50)
        BonkButton.Font = Enum.Font.SourceSans
        BonkButton.Text = ""
        BonkButton.TextColor3 = Color3.fromRGB(0,0,0)
        BonkButton.TextSize = 20.000
        BonkButton.Draggable = true
        BonkButton.MouseButton1Click:Connect(function()
            game.CoreGui:FindFirstChild("BONK_Console").Enabled = not game.CoreGui:FindFirstChild("BONK_Console").Enabled
        end)
        
        BonkButtonHUI.Name = "BonkButtonHUI"
        BonkButtonHUI.Parent = BonkButton

        MODILEMAGE.Name = "MODILEMAGE"
        MODILEMAGE.Parent = BonkButton
